...
<!--
[Explore the scene](https://blockdog-flbnuykvwf.now.sh): this link takes you to a copy of the scene deployed to a remote server where you can interact with it just as if you were running `acl start` locally.
-->
...
Follow the labels on each cube to turn it green, testing all the different ways a player can interact with a Andverse scene.
